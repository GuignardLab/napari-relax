...
All components of the plugin have a button with a question mark on the top right, if you hover your mouse over it, text will appear which will inform the user about the core controls of the component.