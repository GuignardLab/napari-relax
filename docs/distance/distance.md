...
3. [**Approximation/Style selection**](https://guignardlab.github.io/LineageTree/uted/#different-tree-approximations): The approximation to be used in the analysis. CAUTION: Different algorithms have different uses, for more information visit (https://guignardlab.github.io/LineageTree/uted/#different-tree-approximations)
...
1. **Master Controls**: 
    - **Top**: A slider which is able to load the same timepoint on all the histograms simultaneously.
