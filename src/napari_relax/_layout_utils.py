...
from qtpy.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QLayout


def create_horizontal_container(widgets: List[QWidget], parent: QWidget = None) -> QWidget:
    """
...
def create_vertical_container(widgets: List[QWidget], parent: QWidget = None) -> QWidget:
    """
...
class SimpleContainer(QWidget):
    ...
    def __init__(self, widgets: List[QWidget], horizontal: bool = True, parent: QWidget = None):
        """
