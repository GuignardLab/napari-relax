...
class PluginWidgetBase(QWidget):
    ...
    def __init__(self, napari_viewer):
        ...
        if self.module.__overall_widget__:
            ...
            overall_widget = self.module.__overall_widget__(self.viewer, self.signal_hub)
...
class LineageTreeAnalysisWidget(PluginWidgetBase):
    ...
    def _setup_signal_connections(self):
        ...
        if ("Explore and Relabel" in self.widget_dictionary and 
            "Distance Calculation" in self.widget_dictionary):
            ...
            explore_widget.w_lineedit.returnPressed.connect(
                lambda: self.signal_hub.emit_label_update(explore_widget.w_lineedit.text())
            )
        ...
        if ("Attribute Based Recoloring" in self.widget_dictionary and 
            "Explore and Relabel" in self.widget_dictionary):
            
            coloring_widget = self.widget_dictionary["Attribute Based Recoloring"]
            explore_widget = self.widget_dictionary["Explore and Relabel"]
...
class CrossEmbryoManagerComparisonWidget(PluginWidgetBase):
    ...
    def _setup_signal_connections(self):
        ...
        if ("Manager Manipulation" in self.widget_dictionary and 
            "Embryo comparisons" in self.widget_dictionary):
