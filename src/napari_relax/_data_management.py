...
class LineageTreeDataManager:
    ...
    def get_lineage_tree(self) -> LineageTree | None:
        """
    ...
    def select_subtree(self, cell_id: int | None = None) -> int:
        ...
        cell = active_layer.selected_data.pop() if cell_id is None else cell_id

        active_layer.selected_data = {cell}
        descendant_nodes = lT.get_subtree_nodes(
    ...
    def paint_tree_nodes(
        ...
        if color_from_trees:
            ...
            root_nodes = [
                i
                for i, degree in active_layer.metadata["graphs"][0][
                    graph_index
                ].in_degree()
                if degree == 0
            ]
            ...
            if root_nodes:
                ...
                active_layer.face_color[selection] = (
                    DEFAULT_SELECTION_COLOR_RGBA
                )
